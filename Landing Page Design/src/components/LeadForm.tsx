...
export function LeadForm() {
  ...
  return (
    <section id="acesso" className="py-16 lg:py-24 bg-black relative overflow-hidden">
      {/* Background elements */}
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-1/4 w-80 h-80 bg-[#F2FF00]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-[#F2FF00]/3 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-5xl font-black text-white mb-4 leading-tight">
            Seu Acesso{' '}
            <span className="text-[#F2FF00]">Começa Agora</span>
          </h2>
        ...
        <div className="max-w-xl mx-auto">
          <div className="relative bg-black/80 backdrop-blur-sm border border-gray-800 rounded-2xl overflow-hidden shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="bg-gray-800/50 border-gray-700 text-white placeholder-gray-400 focus:border-[#F2FF00] focus:ring-[#F2FF00]/20 h-12 rounded-lg"
                ...
                <Button
                  ...
                  className="w-full h-14 font-bold bg-[#F2FF00] hover:bg-[#E8F500] text-black border-0 rounded-lg transition-all duration-300 hover:scale-105 group relative overflow-hidden mt-6 shadow-lg"
                >
                  {isSubmitting ? (
